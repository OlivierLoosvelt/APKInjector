.class public Lcom/ssl/bypass/EasySSLSocketFactory;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/ssl/bypass/EasySSLSocketFactory;->sslcontext:Ljavax/net/ssl/SSLContext;
...
.method private static createEasySSLContext()Ljavax/net/ssl/SSLContext;
    ...
    new-instance v5, Lcom/ssl/bypass/EasyX509TrustManager;

    const/4 v6, 0x0

    invoke-direct {v5, v6}, Lcom/ssl/bypass/EasyX509TrustManager;-><init>(Ljava/security/KeyStore;)V
...
.method private getSSLContext()Ljavax/net/ssl/SSLContext;
    ...
    .prologue
    .line 35
    iget-object v0, p0, Lcom/ssl/bypass/EasySSLSocketFactory;->sslcontext:Ljavax/net/ssl/SSLContext;

    if-nez v0, :cond_0

    .line 36
    invoke-static {}, Lcom/ssl/bypass/EasySSLSocketFactory;->createEasySSLContext()Ljavax/net/ssl/SSLContext;
...
.method public connectSocket(Ljava/net/Socket;Ljava/lang/String;ILjava/net/InetAddress;ILorg/apache/http/params/HttpParams;)Ljava/net/Socket;
    ...
    :cond_3
    invoke-virtual {p0}, Lcom/ssl/bypass/EasySSLSocketFactory;->createSocket()Ljava/net/Socket;
...
.method public createSocket()Ljava/net/Socket;
    ...
    .prologue
    .line 66
    invoke-direct {p0}, Lcom/ssl/bypass/EasySSLSocketFactory;->getSSLContext()Ljavax/net/ssl/SSLContext;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    const-class v1, Lcom/ssl/bypass/EasySSLSocketFactory;
...
.method public hashCode()I
    ...
    .prologue
    .line 91
    const-class v0, Lcom/ssl/bypass/EasySSLSocketFactory;
